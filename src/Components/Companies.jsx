    ...
    <div className=" max-w-[1600px] mx-auto mb-20 ">
      <div className=" flex flex-col items-center gap-6">
        <h1 className="text-5xl font-[100]">
          <span className="bg-gradient-to-r from-[#FF9006] via-[#E8007D] to-[#8F00FE] font-[600] text-transparent inline-block bg-clip-text">
            Trusted Partners
          </span>{" "}
          Driving Innovation with Us
        </h1>
        <p className="text-lg">Tailored Solutions for Diverse Industries</p>
        <div className="grid grid-cols-5 justify-items-center  w-fit gap-8 py-28 px-6">
          <div className="shadow-lg  border border-gray-300 grayscale-100 hover:grayscale-0 transition-all duration-200 rounded-md px-12 py-6 w-60 h-40">
            <img
              src="/companies/6a8a3c08d080adfdcf6e353c41a92566.jpg.webp"
              alt=""
