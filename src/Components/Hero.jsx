    ...
    <div className="relative h-full w-[100vw] no-scrollbar">
      ...
      <div className="absolute bottom-0 w-full text-white">
        <div className="bg-black/45 flex items-start py-1 justify-evenly text-xl lg:text-2xl xl:text-3xl px-6
                        sm:flex-wrap sm:gap-4 sm:justify-evenly sm:text-lg">
          <div className="flex gap-1 flex-col max-w-[30%] items-center sm:max-w-[45%] xs:max-w-[90%]">
            <img
            ...
            <p className="text-sm md:text-xl font-[300] text-center text-gray-400">
              Global Clients
            </p>
          </div>
          <div className="flex flex-col gap-2 max-w-[30%] items-center sm:max-w-[45%] xs:max-w-[90%]">
            <img
          ...
          <div className="flex flex-col gap-2 max-w-[20%] text-center items-center sm:max-w-[45%] xs:max-w-[90%]">
            <img
          ...
          <div className="flex flex-col gap-2 max-w-[30%] items-center sm:max-w-[45%] xs:max-w-[90%]">
            ...
            <p className="text-sm md:text-xl text-center font-[300] text-gray-400">
              Team Members
            </p>
          </div>
        </div>
